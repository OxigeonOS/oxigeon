...
local function show_item(viewer, item)
    ...
    -- `summary`, not `describe`: this is a bare field in an admin dump, not the
    -- green/red line `examine` shows a player who may or may not qualify.
    local requires = require('components.requires').summary(item)
